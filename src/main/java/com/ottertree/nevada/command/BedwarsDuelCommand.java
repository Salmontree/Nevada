...
@Command(value = "bwd", description = "/bwd <player>", customHelpMessage = { ChatUtil.PREFIX + "§7/§fbwd§7: Challenges a player to a Bed Wars Rush duel.", ChatUtil.INDENT + "§7Usage: /§fbwd §7<player>" })
